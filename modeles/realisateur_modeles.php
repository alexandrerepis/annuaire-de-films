...
function bdd_realList() {
    ...
    $request = "SELECT tbl_realisateurs.id_realisateur, CONCAT(GROUP_CONCAT(DISTINCT tbl_realisateurs.prenom_realisateur SEPARATOR ', '), ' ', tbl_realisateurs.nom_realisateur) 
